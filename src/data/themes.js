...
const _themes = [
  // ========== 正体判明系：実は偉い人 ==========
  {
    ...
    lines1: [
      { speaker: "男性客", text: "遅えんだよ！バイトのくせに気が利かねえな！" },
      { speaker: "男性客", text: "店長呼べよ。お前みたいなバイトじゃ話になんねえ" },
      { speaker: "男性客", text: "バイトの分際で偉そうにするなよ。謝れよ" },
    ],
    lines2: [
      { speaker: "オーナー", text: "店長の私ですが、何かございましたか。この子は私の娘です" },
      { speaker: "オーナー", text: "本日をもって出入り禁止とさせていただきます" },
      { speaker: "男性客", text: "ちょ、ちょっと待ってください…" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "新人", text: "いや、今車の中。運転手のジジイがトロくてさ、マジ最悪" },
      { speaker: "新人", text: "ねえ、もうちょっと飛ばせない？年寄りだから無理？" },
      { speaker: "運転手", text: "安全運転が第一ですので" },
    ],
    lines2: [
      { speaker: "社長", text: "本日は特別顧問をご紹介いたします" },
      { speaker: "社長", text: "元県警本部長の佐藤さんです。私の30年来の旧友でもあります" },
      { speaker: "新人", text: "え…あの運転手のおじさんが…元本部長…？" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "社員", text: "おばちゃん、ちょっと待ってよ。ここ今通れないから" },
      { speaker: "社員", text: "掃除のおばちゃんに挨拶なんかする必要ないだろ" },
      { speaker: "部長", text: "おい、来月からマジで気をつけろよ…" },
    ],
    lines2: [
      { speaker: "社長", text: "育児休暇から復帰されました。取締役の田中です" },
      { speaker: "取締役", text: "現場の皆さんには大変お世話になりました" },
      { speaker: "社員", text: "え…あの清掃員の人が…まさか取締役…？" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "店員", text: "あの、当店のお品物はかなりお値段が張りますが…" },
      { speaker: "老人", text: "孫娘の結婚祝いに何かいいものを贈りたいんだが" },
      { speaker: "店員", text: "こちらは300万円からとなっております" },
    ],
    lines2: [
      { speaker: "老人", text: "そうですか。それでは隣のお店に行きますよ" },
      { speaker: "店長", text: "今の人…まさか鈴木様じゃ…年3000万の最高顧客だぞ！" },
      { speaker: "店員", text: "え…あの方がそんな大切なお客様…？" },
    ],
  ...
  // ========== 正体判明系：実は金持ち ==========
  {
    ...
    lines1: [
      { speaker: "営業", text: "ご試乗ですか？こちらの車種は1800万円からですが" },
      { speaker: "男性", text: "この色いいね。ナビのオプション全部つけたらいくら？" },
      { speaker: "営業", text: "ローンの審査もございますし" },
    ],
    lines2: [
      { speaker: "男性", text: "現金で一括払いでいいよ。あと端数はカードでね" },
      { speaker: "先輩営業", text: "大変失礼いたしました。私が担当させていただきます" },
      { speaker: "男性", text: "ローンの審査、いらなかったね" },
    ],
  ...
  // ========== 因果応報系：嘘がバレる ==========
  {
    ...
    lines1: [
      ...
      { speaker: "女性", text: "慰謝料として30万払いなさい！口コミに書くわよ！" },
      { speaker: "店長", text: "大変申し訳ございません…" },
    ],
    lines2: [
      { speaker: "保健所職員", text: "保健所の者ですが、この店の届出は一件もありません" },
      { speaker: "保健所職員", text: "それにお皿に手をつけた形跡がありませんね" },
      { speaker: "女性", text: "ちょっと…勘違いだったかもしれない…" },
    ],
  ...
  // ========== 因果応報系：証拠が残ってた ==========
  {
    ...
    lines1: [
      { speaker: "上司", text: "パワハラ？そんな事実はない。証拠があるなら出してみろよ" },
      { speaker: "上司", text: "使えねえな。お前の代わりなんかいくらでもいるんだよ！" },
      { speaker: "部下", text: "…はい。分かりました" },
    ],
    lines2: [
      { speaker: "部下", text: "3ヶ月分の録音データがあります。毎日録音していました" },
      { speaker: "上司", text: "おい…やめろ…消せよそれ…" },
      { speaker: "人事部長", text: "最後まで聞かせてください。懲戒委員会に回します" },
    ],
  ...
  // ========== 因果応報系：目撃者がいた ==========
  {
    ...
    lines1: [
      { speaker: "社員A", text: "鈴木ってマジ使えないよな。なんで昇進したんだろ" },
      { speaker: "社員B", text: "コネだろコネ。実力なんかゼロだよあいつは" },
      { speaker: "社員A", text: "来月の異動で飛ばされればいいのにな" },
    ],
    lines2: [
      { speaker: "鈴木", text: "鈴木です。隣の個室にいました" },
      { speaker: "鈴木", text: "全部聞こえてましたよ。壁は薄いですから" },
      { speaker: "鈴木", text: "明日から気まずくなるのは、僕じゃなくて君たちだと思うけど" },
    ],
  ...
  // ========== 弱者の逆襲系：我慢の限界爆発 ==========
  {
    ...
    lines1: [
      { speaker: "夫", text: "おい、飯まだか？早くしろよ" },
      { speaker: "夫", text: "は？離婚届？何これ。冗談だろ？ふざけるなよ" },
  ...
  // ========== 家族の前で恥系 ==========
  {
    ...
    lines1: [
      { speaker: "父親", text: "おい、前回箸入ってなかっただろ！何回言えばわかるんだ！" },
      { speaker: "父親", text: "俺は客だぞ？客に向かってその態度はなんだ？" },
      { speaker: "店員", text: "大変申し訳ございません…" },
    ],
    lines2: [
      { speaker: "娘", text: "パパ…最低だよ…恥ずかしいよ…" },
      { speaker: "娘", text: "お姉さん、本当にごめんなさい。パパの代わりにごめんなさい" },
      { speaker: "父親", text: "…すみませんでした。本当に申し訳ない" },
    ],
  ...
  // ========== 正体判明系：実は偉い人（追加） ==========
  {
    ...
    lines1: [
      { speaker: "住民女性", text: "ちょっと、汚い格好でベンチに居座らないでくれる？" },
      { speaker: "住民女性", text: "ホームレスなら駅前に行ってちょうだい。住民が迷惑してるの" },
      { speaker: "男性", text: "…そうですか。分かりました" },
    ],
    lines2: [
      { speaker: "秘書", text: "市長！お待たせしました。次の視察先の準備が整いました" },
      { speaker: "住民女性", text: "し…市長ですって…？まさか…" },
      { speaker: "市長", text: "公園は誰でも使える場所です。それが行政の基本ですから" },
    ],
  ...
  // ========== 正体判明系：実は金持ち（追加） ==========
  {
    ...
    lines1: [
      { speaker: "ママ友A", text: "見て、あの人また同じ服よ。給食費も大変なんじゃない？" },
      { speaker: "ママ友A", text: "うちの子とあんまり遊ばせたくないのよね" },
      { speaker: "ママ友B", text: "家も古いアパートらしいわよ、可哀想" },
    ],
    lines2: [
      { speaker: "校長", text: "5000万円のご寄付をいただきました。山田美咲様です" },
  ...
  },
  {
    ...
    lines1: [
      { speaker: "若者", text: "うわ、見ろよこのボロ軽トラ。こんなの乗って恥ずかしくないの？" },
      { speaker: "若者", text: "じいちゃん、ここ月極3万の駐車場だよ？場違いじゃない？" },
      { speaker: "老人", text: "そうかい。3万かい" },
    ],
    lines2: [
      { speaker: "管理人", text: "地主の鈴木様！本日はありがとうございます！" },
  ...
  },
  {
    ...
    lines1: [
      { speaker: "支配人", text: "申し訳ございませんが、当店にはドレスコードがございまして" },
      { speaker: "女性", text: "予約してある佐々木です。服装の指定はなかったはずですが" },
      { speaker: "支配人", text: "お客様のお召し物ではちょっと…" },
    ],
    lines2: [
      { speaker: "シェフ", text: "何やってるんだ！あの方はミシュランの覆面審査員だぞ！" },
      { speaker: "支配人", text: "え…ミシュランの審査員…？" },
      { speaker: "シェフ", text: "全部終わった…ミシュランの星は一つもつかなかった" },
    ],
  ...
  // ========== 正体判明系：実は関係者 ==========
  {
    ...
    lines1: [
      { speaker: "男", text: "知らないね。席なんて早い者勝ちだろ。どけよ" },
      { speaker: "女性客", text: "すみません、チケットにこの席番号が書いてあるんですが" },
      { speaker: "男", text: "うるせえな。車掌でも呼べば？どうせ来ないけど" },
    ],
    lines2: [
      { speaker: "車掌", text: "社長、大変お待たせいたしました。何かございましたか" },
      { speaker: "男", text: "しゃ…社長…？この人が社長…？" },
      { speaker: "社長", text: "ええ。この路線を運営している会社の社長です" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "学生", text: "正直に言うと、滑り止めですね。本命は大手のA社なんで" },
      { speaker: "学生", text: "こういう小さい会社だと将来性がちょっと…" },
      { speaker: "面接官", text: "そうですか。お話、よく分かりました" },
    ],
    lines2: [
      { speaker: "面接官", text: "A社の社外取締役として最終面接を担当します。先週もお会いしましたね" },
      { speaker: "学生", text: "あ…あの時は…その…" },
      { speaker: "面接官", text: "小さい会社の面接官が、大企業の最終面接に座ることもある" },
    ],
    endText: "世界は思ったより狭い",
  },
  {
    ...
    lines1: [
      { speaker: "酔った男", text: "おい、もっと飛ばせよ！遅いんだよクソジジイ！" },
      { speaker: "酔った男", text: "こんな運転じゃ免許返納しろ。年寄りはとっとと引退しろ" },
      { speaker: "運転手", text: "…大変申し訳ございません" },
    ],
    lines2: [
      { speaker: "女性", text: "運転手さん、次の信号で停めてください。国土交通省の者です" },
      { speaker: "女性", text: "今の暴行と暴言、全て記録させていただきました" },
      { speaker: "酔った男", text: "え…国土交通省…冗談でしょ…" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "客", text: "あんた何年目？新人でしょ？ベテランに変えて" },
      { speaker: "客", text: "若い子に任せて失敗したくないの。店長呼んで" },
      { speaker: "オーナー", text: "お客様、彼女は当店のトップスタイリストです" },
    ],
    lines2: [
      { speaker: "オーナー", text: "全国大会優勝者です。指名は3ヶ月待ちの人気スタイリストですよ" },
      { speaker: "客", text: "…そうだったの…すごいのね…" },
      { speaker: "客", text: "さっきは本当にごめんなさい。次も指名していい？" },
    ],
  ...
  // ========== 因果応報系：嘘がバレる（追加） ==========
  {
    ...
    lines1: [
      { speaker: "社員", text: "すみません…38度の熱が出まして…今日はお休みさせてください…" },
      { speaker: "社員", text: "いやー、昨日は大変だったよ。熱がすごくてさ" },
      { speaker: "同僚", text: "…そうなんだ。お大事に" },
    ],
    lines2: [
      { speaker: "課長", text: "38度の熱で絶叫マシン、乗れるんだ？すごいわね" },
      { speaker: "課長", text: "私、あなたのフォロワーなの。知らなかった？" },
      { speaker: "課長", text: "謝る相手は私じゃなくて田辺さんよ" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "部長", text: "だからFラン卒は使えないんだよ。俺みたいに東大出てればな" },
      { speaker: "部長", text: "東大の法学部で学んだ論理的思考がお前らにはないんだよ" },
      { speaker: "社員", text: "…はい、すみません" },
    ],
    lines2: [
      { speaker: "社員", text: "法学部の卒業生名簿にお名前がないんですが" },
  ...
  },
  {
    ...
    lines1: [
      { speaker: "夫", text: "ただいま。今日も残業で遅くなったよ、悪いな" },
      { speaker: "妻", text: "お疲れ様。ちょっとこっちに座ってくれる？" },
      { speaker: "妻", text: "会社から残業記録をもらったの。先月の残業、ゼロだったよ" },
    ],
    lines2: [
      { speaker: "妻", text: "毎週木曜日、渋谷のホテル街。6ヶ月で24回" },
      { speaker: "夫", text: "違うんだ、説明させてくれ" },
      { speaker: "妻", text: "弁護士には連絡済み。カーナビの記録は証拠として提出します" },
    ],
    endText: "嘘は、データに勝てない",
  },
  // ========== 因果応報系：証拠が残ってた（追加） ==========
  {
    ...
    lines1: [
      { speaker: "役員", text: "セクハラ？彼女の勘違いだよ。肩をポンと叩いただけだ" },
      { speaker: "役員", text: "証拠がないならこれ以上は名誉毀損になるぞ" },
      { speaker: "弁護士", text: "では、こちらの証拠をお見せしましょう" },
    ],
    lines2: [
      { speaker: "弁護士", text: "3階廊下の防犯カメラの映像です。肩を叩いただけですか？" },
      { speaker: "弁護士", text: "過去6ヶ月分、17件の映像があります。すべて提出済みです" },
      { speaker: "役員", text: "待ってくれ…示談で…" },
    ],
    endText: "カメラは、嘘をつかない",
  },
  {
    ...
    lines1: [
      { speaker: "いじめっ子", text: "いじめ？してませんよ。ちょっとふざけてただけですって" },
      { speaker: "いじめっ子", text: "な？ふざけてただけだよな？自分で転んだって言えよ" },
      { speaker: "先生", text: "田中くんの腕の痣はどう説明するの？" },
    ],
    lines2: [
      { speaker: "先生", text: "クラスメイト5人が別々に撮影した動画があります" },
      { speaker: "先生", text: "保護者と教育委員会にはすでに報告済みです" },
      { speaker: "母親", text: "あなた…何やってるの…信じられない" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "女", text: "何も盗ってないわよ！冤罪よ！訴えるわよ！" },
      { speaker: "女", text: "これ私じゃないわ！似てる人はいくらでもいるでしょ！" },
      { speaker: "店長", text: "ポケットの中を見せていただけますか" },
    ],
    lines2: [
      { speaker: "店長", text: "何も盗っていない、とおっしゃいましたよね？" },
      { speaker: "警備員", text: "商品をポケットに入れてレジを通過する映像が残っています" },
      { speaker: "店長", text: "では警察に連絡させていただきます" },
    ],
  ...
  // ========== 因果応報系：目撃者がいた（追加） ==========
  {
    ...
    lines1: [
      { speaker: "車の持ち主", text: "嘘でしょ…こんな傷…当て逃げされたの？" },
      { speaker: "目撃者", text: "あの、昨夜のことなら全部見てましたよ" },
      { speaker: "目撃者", text: "不眠症でベランダにいたんです。動画も撮ってあります" },
    ],
    lines2: [
      { speaker: "犯人", text: "知りません。その時間は家で寝ていました" },
      { speaker: "警察", text: "向かいのマンション8階から撮影された映像がありますが" },
      { speaker: "警察", text: "当て逃げは刑事罰の対象になりますよ" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "女", text: "ちょっと邪魔なのよ！どきなさい！こっちは急いでるの！" },
      { speaker: "女", text: "親はどこよ。まったくしつけがなってないわね" },
      { speaker: "女", text: "泣くんじゃないわよ。ぶつかったのはそっちでしょ" },
    ],
    lines2: [
      { speaker: "PTA会長", text: "子供を突き飛ばしましたよね。全員見てました" },
      { speaker: "PTA役員", text: "この子、膝を擦りむいてますよ" },
      { speaker: "PTA会長", text: "佐藤くんのお母さんよね？PTA会議で話し合いましょう" },
    ],
  ...
  // ========== 因果応報系：ブーメラン ==========
  {
    ...
    lines1: [
      { speaker: "先輩", text: "あいつの実力じゃないだろ。ただの運だよ、運" },
      { speaker: "同僚", text: "でも山田くん、転職先で新規事業賞取ったらしいですよ" },
      { speaker: "先輩", text: "ふん、向こうのレベルが低いだけだろ" },
    ],
    lines2: [
      { speaker: "人事", text: "高橋さんは人員削減の対象者リストに入っています" },
      { speaker: "先輩", text: "なんで俺が？10年もいるんだぞ" },
      { speaker: "人事", text: "山田さんの案件、引き継ぎ後すべて失注しています" },
    ],
  ...
  },
  {
    ...
    lines1: [
      ...
      { speaker: "姑", text: "大輔、こんな女とは早く別れなさい" },
      { speaker: "嫁", text: "…長い間、お世話になりました" },
    ],
    lines2: [
      { speaker: "息子", text: "僕も美咲と一緒に出ていく" },
      { speaker: "姑", text: "何言ってるの！母親を捨てるっていうの？" },
      { speaker: "息子", text: "5年間黙っててごめん。母さんが美咲を捨てるなら僕はこの家を出る" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "上司", text: "この新規事業案は私が3ヶ月かけて一人で作りました" },
      { speaker: "社長", text: "5ページ目の市場予測、根拠となるデータソースは？" },
      { speaker: "上司", text: "え…それは…一般的な市場データを…" },
    ],
    lines2: [
      { speaker: "部下", text: "私が作成した企画書です。データソースはNRI総研です" },
      { speaker: "部下", text: "ファイルの作成者ログに私の名前だけが残っています" },
      { speaker: "社長", text: "鈴木さん、改めてプレゼンしてくれるか" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "噂好き", text: "あの田中さんね、実は旦那さんが借金まみれらしいわよ" },
      { speaker: "噂好き", text: "子供の塾代も払えてないんですって。可哀想よねー" },
      { speaker: "田中さん", text: "あれ、今日のお茶会、連絡もらってないけど…" },
    ],
    lines2: [
      { speaker: "リーダー", text: "田中さんの旦那さん、借金なんてないよ。直接聞いた" },
      { speaker: "リーダー", text: "3人に違う話をしてたの。全部スクショに残ってるよ" },
      { speaker: "リーダー", text: "嘘を広める人とは付き合えない" },
    ],
  ...
  // ========== 因果応報系：過去の因果 ==========
  {
    ...
    lines1: [
      { speaker: "元いじめっ子", text: "よろしくお願いしま…中村…？なんで…ここに…" },
      { speaker: "面接官", text: "田中太郎さんですね。どうぞお座りください" },
      { speaker: "元いじめっ子", text: "前職は…人間関係がうまくいかなくて退職しました…" },
    ],
    lines2: [
      { speaker: "面接官", text: "正直に言うと、あなたのことは覚えています。中学の同級生だ" },
      { speaker: "面接官", text: "でも面接は公平に行います。過去は関係ありません" },
      { speaker: "元いじめっ子", text: "あの時は…本当にすみませんでした" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "男", text: "美紀…？嘘だろ…社長になったのか…" },
      { speaker: "女性社長", text: "お久しぶりです。営業のご提案ですね。お座りください" },
      { speaker: "男", text: "すごいな…あの美紀が、こんな会社の社長に…" },
    ],
    lines2: [
      { speaker: "女性社長", text: "つまらない女なりに、必死に頑張りましたから" },
      { speaker: "男", text: "あの時の俺は…本当に最低だった…すまなかった" },
      { speaker: "女性社長", text: "あなたに振られたから、自分で会社を作ろうと思ったの" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "恩師", text: "おお、山田くん！久しぶりだな！元気にしてたか？" },
      { speaker: "男", text: "あ、すみません、ちょっと急いでるんで…" },
      { speaker: "男", text: "…え…先生…？なんで先生が主治医なんですか…？" },
    ],
    lines2: [
      { speaker: "恩師", text: "やあ、山田くん。今度はちゃんと覚えてくれたかな" },
      { speaker: "恩師", text: "教師を辞めた後にね、医学部に入り直したんだよ" },
      { speaker: "恩師", text: "先生はいつだって生徒の味方だよ" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "おじ", text: "こいつは血が繋がってないからな。本当の家族じゃないだろ" },
      { speaker: "養母", text: "お兄さん、そんなひどいこと言わないで…" },
      { speaker: "養子", text: "おじさん、大変なことになったと聞きました" },
    ],
    lines2: [
      { speaker: "おじ", text: "なんで…お前に一番ひどいことを言ったのに…" },
      { speaker: "養子", text: "おじさんが困ってるなら、助けるのが家族でしょう" },
      { speaker: "養子", text: "血は関係ありません。僕はこの家族の一員です" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "先輩", text: "後輩が奢るのは当たり前だろ？それが社会のルールだ" },
      { speaker: "先輩", text: "予約は取れなかったけど、一人くらい入れるだろ" },
      { speaker: "受付", text: "申し訳ございません。完全予約制です" },
    ],
    lines2: [
      { speaker: "シェフ", text: "お久しぶりです、先輩。覚えてますか？" },
      { speaker: "シェフ", text: "3年間で200回以上、全額僕が払いましたよね" },
      { speaker: "シェフ", text: "申し訳ないですが、2ヶ月先まで満席です。ルールですので" },
    ],
  ...
  // ========== 逆転系：立場逆転（キャリア） ==========
  {
    ...
    lines1: [
      { speaker: "正社員", text: "バイトは黙ってろよ。余計なことすんな" },
      { speaker: "正社員", text: "新しい課長が来るらしいな。どうせ誰でもいいけどさ" },
      { speaker: "正社員", text: "え…あのバイトの佐藤が…課長…？嘘だろ…" },
    ],
    lines2: [
      { speaker: "新課長", text: "2年前までここでアルバイトをしていた佐藤です" },
      { speaker: "新課長", text: "MBAを取得し、本社を経て戻ってきました" },
      { speaker: "新課長", text: "バイト時代に色々教えていただき、感謝しています" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "社員", text: "派遣のくせに意見するな。言われたことだけやれ" },
      { speaker: "部長", text: "今日の商談、絶対失敗するなよ。相手は新任の執行役員だ" },
      { speaker: "社員", text: "あの派遣の人が…執行役員…？" },
    ],
    lines2: [
      { speaker: "元派遣", text: "以前こちらの会社で派遣社員としてお世話になりました" },
      { speaker: "元派遣", text: "では、ご提案をお聞きしましょう" },
  ...
  },
  {
    ...
    lines1: [
      { speaker: "元教師", text: "お前は何をやってもダメだ。大学なんか行けるわけがない" },
      { speaker: "元教師", text: "木村…？まさか…あの木村が部長…？" },
      { speaker: "部長", text: "お久しぶりです、山下先生。お元気でしたか" },
    ],
    lines2: [
      { speaker: "元教師", text: "あの頃は…本当にひどいことを言ってしまった…" },
      { speaker: "部長", text: "先生のあの言葉がなかったら今の自分はいません" },
      { speaker: "部長", text: "今は同僚です。改めて、よろしくお願いします" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "面接官", text: "うーん、うちには合わないかな。はい、不採用ということで" },
      { speaker: "応募者", text: "あの…まだポートフォリオもお見せしていないんですが…" },
      { speaker: "面接官", text: "もう結構です。次の方どうぞ" },
    ],
    lines2: [
      { speaker: "副社長", text: "A社に最大のクライアント3社を持っていかれた！" },
      { speaker: "面接官", text: "この人…半年前にうちで3分で不採用にしました…" },
      { speaker: "副社長", text: "お前が3分で5億を捨てたんだ" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "取引先", text: "面倒くさいな。受付嬢ごときが偉そうにするなよ" },
      { speaker: "取引先", text: "こっちは年間2億の取引先だぞ！受付の小娘に用はない！" },
      { speaker: "受付", text: "セキュリティ上の確認ですので、ご協力をお願いします" },
    ],
    lines2: [
      { speaker: "創業者", text: "この子は私の娘です。来月から彼女がこの会社のCEOになります" },
      { speaker: "取引先", text: "お嬢様が…受付の仕事を…？" },
      { speaker: "新CEO", text: "受付の小娘からご連絡です。契約を見直します" },
    ],
  ...
  // ========== 逆転系：栄枯盛衰 ==========
  {
    ...
    lines1: [
      { speaker: "マウント女", text: "これ5カラットよ。あなたの旦那さん、年収いくらなの？" },
      { speaker: "マウント女", text: "うちはタワマンの最上階。ねえ、まだ賃貸なの？" },
      { speaker: "マウント女", text: "やっぱり努力が足りないのよ" },
    ],
    lines2: [
      { speaker: "友人", text: "あの人、旦那さんの会社が倒産して離婚したらしいわよ" },
      { speaker: "マウント女", text: "あの時の私は…本当に嫌な人だったよね…" },
      { speaker: "女性", text: "昔のことはもういいよ。一緒に飲もう" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "インフルエンサー", text: "これ、オーダーと違うんだけど！何回言えば分かるの？" },
      { speaker: "インフルエンサー", text: "私のフォロワー100万人に言ったら、この店終わるからね？" },
      { speaker: "店員", text: "申し訳ございません…" },
    ],
    lines2: [
      { speaker: "インフルエンサー", text: "なんで…あの動画が流出してるの…嘘でしょ" },
      { speaker: "マネージャー", text: "スポンサー3社から契約解除の連絡が来た。CMも白紙だ" },
      { speaker: "インフルエンサー", text: "フォロワーが…どんどん減っていく…" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "社長", text: "木村、会社の金を使い込んだのか" },
      { speaker: "部長", text: "何かの間違いですよ。私がそんなことするわけが" },
      { speaker: "経理", text: "過去10年間で合計4700万円の不一致があります" },
    ],
    lines2: [
      { speaker: "経理", text: "架空の接待費、存在しない業者への支払い。全て部長の承認印です" },
      { speaker: "部長", text: "20年の付き合いじゃないですか…" },
      { speaker: "社長", text: "20年信じていた。だからこそ許せない" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "議員", text: "文句があるなら自分で出馬しろよ。黙ってろ" },
      { speaker: "議員", text: "住民なんて選挙の時だけ愛想振りゃいいんだよ" },
      { speaker: "住民", text: "あの議員は何もしてくれない。道路の補修も放置だ" },
    ],
    lines2: [
      { speaker: "アナウンサー", text: "開票結果です。新人候補38891票、現職候補15234票" },
      { speaker: "新人候補", text: "皆さんの声をこれからもずっと聞き続けます" },
      { speaker: "議員", text: "…20年…全部終わった…" },
    ],
  ...
  // ========== 集団系：全員が味方 ==========
  {
    ...
    lines1: [
      { speaker: "課長", text: "こんな企画書、幼稚園児でも書けるわ！やり直せ！" },
      { speaker: "課長", text: "文句があるなら辞めろ！お前の代わりなんかいくらでもいる！" },
      { speaker: "社員", text: "明日の朝、全員で出しましょう" },
    ],
    lines2: [
      { speaker: "課長", text: "おい、この辞表の山はどういうことだ！" },
      { speaker: "社員", text: "代わりはいくらでもいると。では代わりを探してください" },
      { speaker: "社員", text: "パワハラの記録も全て人事に提出済みです" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "学級委員", text: "先生、また石田くんがいじめられています。助けてください" },
      { speaker: "担任", text: "子供同士のじゃれ合いだろ。大げさだな" },
      { speaker: "担任", text: "いじめなんてこのクラスにはない。席に戻りなさい" },
    ],
    lines2: [
      { speaker: "学級委員", text: "いじめが放置されています。これはクラス全員36人の署名です" },
      { speaker: "担任", text: "校長、これは生徒たちの反抗です…" },
      { speaker: "校長", text: "36人全員が反抗だと？それは指導の問題だ" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "客", text: "おい、注文間違えただろ！金返せ！全部ただにしろ！" },
      { speaker: "客", text: "客は神様なんだよ！俺が言うことは絶対なんだよ！" },
      { speaker: "店員", text: "す、すみません…申し訳ございません…" },
    ],
    lines2: [
      { speaker: "店長", text: "当店はスタッフへの暴力・暴言を許容しません。お引き取りください" },
      { speaker: "調理師", text: "警察呼びましょうか、店長" },
      { speaker: "店長", text: "よく耐えたね。もう大丈夫だから安心して" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "姑", text: "この子は料理もまともにできないのよ。うちの家の恥だわ" },
      { speaker: "姑", text: "子供もまだできないし。嫁として完全に失格ね" },
      { speaker: "姑", text: "ねえ、みんなもそう思うでしょ？" },
    ],
    lines2: [
      { speaker: "叔母", text: "姉さん、いい加減にしなさい" },
      { speaker: "おじ", text: "この料理全部美咲さんが作ったんだぞ。うまいじゃないか" },
      { speaker: "叔母", text: "美咲さんがいなかったら、この法事も成り立たなかった" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "若者", text: "知らねーよ。席なんて先に座ったもん勝ちだろ" },
      { speaker: "若者", text: "自分で妊娠しといて自己責任じゃん。甘えんなよ" },
      { speaker: "妊婦", text: "お腹が大きくて立っているのがつらいんです…" },
    ],
    lines2: [
      { speaker: "サラリーマン", text: "お嬢さん、こちらの席にどうぞ。遠慮なく座ってください" },
      { speaker: "サラリーマン", text: "君、優先席の意味を知ってるか？" },
      { speaker: "おばあさん", text: "あなただって誰かのお腹から生まれてきたんでしょう" },
    ],
  ...
  // ========== 通報系：警察を呼ぶ ==========
  {
    ...
    lines1: [
      { speaker: "男", text: "おい！ぶつけただろ！降りろ！どうしてくれるんだ！" },
      { speaker: "男", text: "うるせえ！つべこべ言わずに金出せ！" },
      { speaker: "元刑事", text: "落ち着いてください。接触はしていませんよ" },
    ],
    lines2: [
      { speaker: "元刑事", text: "暴行罪で現行犯逮捕できますが、どうされますか" },
      { speaker: "男", text: "な、何者だよ…お前いったい…" },
      { speaker: "元刑事", text: "元刑事です。30年やってました。妻は元鑑識課ですよ" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "元彼", text: "なあ、頼むから話だけでも聞いてくれよ。やり直せるだろ？" },
      { speaker: "元彼", text: "出て来いよ！いい加減無視するなって！開けろよ！" },
      { speaker: "女性", text: "帰ってください。もう終わったんです" },
    ],
    lines2: [
      { speaker: "警察", text: "ストーカー規制法の警告を出しています。3回目ですよ" },
      { speaker: "女性", text: "3ヶ月分の記録、200件のメッセージ、GPS記録です" },
      { speaker: "警察", text: "相手が嫌がっていることが全てです" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "客", text: "なんで融資が降りねえんだよ！ふざけるな！" },
      { speaker: "客", text: "支店長呼べ！ここで暴れてやるからな！" },
      { speaker: "窓口", text: "支店長をお呼びしますので、少々お待ちください" },
    ],
    lines2: [
      { speaker: "客", text: "は？警察だと？誰が呼んだんだよ！" },
      { speaker: "窓口", text: "私が通報しました。業務妨害と器物損壊の件で" },
      { speaker: "窓口", text: "大変お待たせいたしました。次の番号札のお客様、どうぞ" },
    ],
  ...
  // ========== 専門知識系：専門家に論破される ==========
  {
    ...
    lines1: [
      { speaker: "患者", text: "ネットに書いてあったんだけど、この薬は副作用が多いよ" },
      { speaker: "患者", text: "この治療法は古いって書いてあった" },
      { speaker: "患者", text: "医者ももうちょっと勉強した方がいいよ" },
    ],
    lines2: [
      { speaker: "医師", text: "その記事の参考文献の論文、書いたの私です" },
      { speaker: "医師", text: "この分野の教科書も私が書きました。第7版まで出ています" },
      { speaker: "医師", text: "何でも聞いてください。ネットじゃなくて、私に" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "隣人", text: "お宅の室外機がうるさい！民法709条で訴えてやる！" },
      { speaker: "隣人", text: "騒音は刑法の傷害罪にもなるからな！慰謝料300万だ！" },
      { speaker: "隣人", text: "俺は法律に詳しいんだ！" },
    ],
    lines2: [
      { speaker: "弁護士", text: "いくつか訂正させてください。私、弁護士なんです" },
      { speaker: "弁護士", text: "騒音で傷害罪は成立しません。条文の読み間違いですね" },
      { speaker: "弁護士", text: "嘘の法律で脅すのは脅迫罪です。これは本当の法律です" },
    ],
  ...
  },
  {
    ...
    lines1: [
      { speaker: "客", text: "この味付け、プロの仕事じゃないね。素人レベルだ" },
      { speaker: "客", text: "僕はパリで三ツ星に何度も行ってるから分かるんだよ" },
      { speaker: "常連", text: "もう少し食べてから言ったらどうかしら" },
    ],
    lines2: [
      { speaker: "シェフ", text: "ギィ・サヴォワですか。私はそこのスーシェフでした" },
      { speaker: "シェフ", text: "パリで10年修業してから、地元に戻ってこの店を開きました" },
      { speaker: "客", text: "すみません…食べさせてください。…美味い" },
    ],
